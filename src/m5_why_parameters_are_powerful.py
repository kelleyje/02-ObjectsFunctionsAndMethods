...
def main():
    ...
    # even_better_draw_circles(rg.Point(100, 50), 4, 60, "red", 1)
    # even_better_draw_circles(rg.Point(-200, 0), 30, 3, "lime green", 10)

    note = rg.SimpleTurtle()

    even_better_draw_circles(rg.Point(0, 0), 40, 15, "black", 30)
    even_better_draw_circles(rg.Point(300, 300), 15, 20, "red", 5)
    even_better_draw_circles(rg.Point(-300, 300), 15, 20, "green", 5)
    even_better_draw_circles(rg.Point(-300, -300), 15, 20, "yellow", 5)
    even_better_draw_circles(rg.Point(300, -300), 15, 20, "blue", 5)
...
def better_draw_circles(point, radii_increase):
    """
    ...
    for k in range(1, 11):  # k becomes 1, 2, 3, ... 10
        ...
        # Go DOWN 15 pixels, ending up pointing east again
        turtle.right(90)
        turtle.forward(radii_increase)
        turtle.left(90)

        turtle.pen_down()
        turtle.draw_circle(radii_increase * k)
...
def even_better_draw_circles(point, radii_increase, number_of_circles, pen_color, pen_thickness):
    ...
    for k in range(1, number_of_circles + 1):

...
def try_methods_and_functions():
    ...
    ###########################################################################
    note = rg.SimpleTurtle()
    note.pen = rg.Pen("blue", 5)

    note.backward(150)

    note.speed = 1

    draw_many_squares(note, 2, 100, 30)

    note.speed = 5
    note.pen = rg.Pen("red", 5)

    draw_many_squares(note, 10, 50, 15)

    note.speed = 100
    note.pen = rg.Pen("red", 35)

    draw_many_squares(note, 8, 300, 60)

    note.pen = rg.Pen("black", 3)
